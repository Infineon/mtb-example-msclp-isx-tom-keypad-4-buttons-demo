...
/* Active mode Scan time calculated in us ~= 536us */
#define ACTIVE_MODE_FRAME_SCAN_TIME     (536u)

/* Active mode Processing time in us ~= 93us with LEDs and Tuner disabled*/
#define ACTIVE_MODE_PROCESS_TIME        (93u)

/* ALR mode Scan time calculated in us ~= 536us */
#define ALR_MODE_FRAME_SCAN_TIME        (536u)

/* ALR mode Processing time in us ~= 93us with LEDs and Tuner disabled*/
#define ALR_MODE_PROCESS_TIME           (93u)
 ...
 ********************************************************************************
 * Summary:
 *  Control LEDs on the expansion board as-
 *  No press - LED == OFF
 *    Press - LED == ON
 *  Toggles the LED corresponding to the button pressed
 *******************************************************************************/
void led_control()
{
